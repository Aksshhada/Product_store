...
const CreatePage = () => {
  ...
  return (
    <Box position="relative" minH="100vh">
      <Container maxW="container.sm" overflow="hidden" zIndex={1} position="relative">
        <VStack spacing={8}>
